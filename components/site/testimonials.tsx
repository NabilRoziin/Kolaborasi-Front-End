...
const DATA: Testimonial[] = [
  {
    ...
    text: "Makanan Yang sangat enak, cocok dinikmati ketika makan siang",
    reviews: "1 Review",
    timeAgo: "Seminggu lalu",
    highlight: true,
  ...
  },
  {
    ...
    text: "Burgernya sangat enak, bahan bahanya juga fresh.",
    reviews: "2 Reviews",
  ...
  },
  {
    ...
    text: "Aku suka bagian Menu Kopinya, mereka memiliki banyak varian kopi Arabika.",
    reviews: "1 Review",
