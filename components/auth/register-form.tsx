...
export function RegisterForm({ role = "customer" }: { role?: "customer" | "staff" }) {
  ...
  return (
    <Card className="mx-auto w-full max-w-sm p-8 md:p-10">
      <h1 className="mb-1 text-center text-2xl font-semibold tracking-tight text-balance">Create {roleText} Account</h1>
      <p className="mb-6 text-center text-sm text-muted-foreground">{roleDescription}</p>
